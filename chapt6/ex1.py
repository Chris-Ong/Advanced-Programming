...
slice_from_index_3 = a[3:]
print("Elements from index 3 to the end of the array:", slice_from_index_3)

# Slice elements from index 0 to index 4
slice_from_index_0_to_4 = a[0:5]
print("Elements from index 0 to index 4:", slice_from_index_0_to_4)

# Print [32, 15, 67] using negative slicing
negative_slice = a[-5:-2]
print("Elements using negative slicing:", negative_slice)
